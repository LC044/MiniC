...
expr        : expr '=' expr{$$ = new_ast_node(AST_OP_ASSIGN, $1, $3);}
            | expr T_AND expr{$$ = new_ast_node(AST_OP_ADD, $1, $3);}
            | expr T_OR expr{$$ = new_ast_node(AST_OP_ADD, $1, $3);}
...
cmp     : T_CMP{
            ...
            temp_val.lineno = $1.lineno;
            switch($1.id){
                case '>': strncpy(temp_val.id, "gt", sizeof(temp_val.id));break;
                case '<': strncpy(temp_val.id, "lt", sizeof(temp_val.id));break;
                case '>=': strncpy(temp_val.id, "ge", sizeof(temp_val.id));break;
                case '<=': strncpy(temp_val.id, "le", sizeof(temp_val.id));break;
                case '==': strncpy(temp_val.id, "eq", sizeof(temp_val.id));break;
                case '!=': strncpy(temp_val.id, "ne", sizeof(temp_val.id));break;
            }
