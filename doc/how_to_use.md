...
<div style="background-color: #DFEEFD">
    算法流程:
    <p>  1. 遇到if节点,新建三个label, 将前两个label分别入栈BC1,BC2,访问表达式语句</p>
    <p>  2. 遇到OR节点新建一个label，将label压入BC2栈，访问左孩子节点，弹出BC2的栈顶元素，访问右孩子节点</p>
    <p>  3. 遇到AND节点新建一个label，将label压入BC1栈，访问左孩子节点，弹出BC1的栈顶元素，访问右孩子节点</p>
    <p>  4. 遇到NOT节点互换两个栈顶元素，访问左孩子节点，互换两个栈顶元素</li>
    <p>  5. 遇到CMP节点，新建bool类型临时变量，表达式为真跳转到BC1的栈顶元素，否则跳转到BC2的栈顶元素</p>
</div>
算法示意
...
做一件事情只需要两步：首先就是开始、其次则是做下去。大多数人都没能通过第一步，还有部分人困在了第二步，只有极少数人能够做到最后。
很多人说这门课“性价比”不高，只有两个学分却要花这么大的精力。
*的确是这样。*
从2023年5月21日开始到2023年6月28日完成，一个月的时间几乎每天都花至少四个小时去think、code、debug、refactor。

但是，如果你能坚持做下去，你将会发现数据结构、算法、操作系统、软件工程这些课没有一门课是白学的。因为你需要用到大学几年的所有知识才能把这个作业或是项目做好。

跟打游戏一样，写代码也会上瘾，从0到1、升级打怪的感觉总会让人废寝忘食。

<img title="14245" src="image/img7.png" alt="alt text" data-align="center">

完事开头难，5月21日第一次开始做实验的时候我也是无从下手，花了整整两天时间找了很多资料、代码，发现能用的很少，所以我希望该文档能帮助你开始第一步、进而完成第二步。
<img src="image/img6.png" title="" alt="alt text" data-align="center">

附上我的Git提交记录（这是我第一次接触C++）
