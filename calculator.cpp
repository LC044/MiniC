...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    T_DIV = 263,                   /* T_DIV  */
    T_SUB = 264,                   /* T_SUB  */
    T_LPAREN = 265,                /* T_LPAREN  */
    T_RPAREN = 266,                /* T_RPAREN  */
...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_T_LPAREN = 10,                  /* T_LPAREN  */
  YYSYMBOL_T_RPAREN = 11,                  /* T_RPAREN  */
...
{
       0,    57,    57,    62,    67,    75,    92,   100,   109,   116,
     123,   129,   136,   143,   148,   159,   171,   175,   180,   191,
     202
};
#endif
...
static const char *const yytname[] =
{
  ...
  "T_FLOAT", "T_MUL", "T_ADD", "T_DIV", "T_SUB", "T_LPAREN", "T_RPAREN",
  "T_ASSIGN", "T_SEMICOLON", "'|'", "UMINUS", "$accept", "Input", "Block",
  "Statement", "Expr", "Term", "P", "Factor", YY_NULLPTR
};
...
{
       3,   -18,   -10,   -18,    19,    19,    19,    33,     3,   -18,
      18,     9,   -18,   -18,    19,   -18,   -18,   -18,     7,   -18,
     -18,    19,    19,   -18,    19,    19,    23,   -18,     9,     9,
     -18,   -18,   -18
};
...
{
       0,    18,    20,    19,     0,     0,     0,     0,     2,     3,
       7,    10,    13,    16,     0,    20,    14,    15,     0,     1,
       4,     0,     0,     6,     0,     0,     0,    17,     8,     9,
      11,    12,     5
};
...
{
      16,    17,    14,    18,    28,    29,     1,     2,     3,    20,
       4,    26,     5,     6,    21,    24,    22,    25,    27,     0,
      30,    31,     1,    15,     3,    21,     4,    22,     5,     6,
      21,    23,    22,    19,     0,     0,    32
};

static const yytype_int8 yycheck[] =
{
       4,     5,    12,     6,    21,    22,     3,     4,     5,     8,
       7,    14,     9,    10,     7,     6,     9,     8,    11,    -1,
      24,    25,     3,     4,     5,     7,     7,     9,     9,    10,
       7,    13,     9,     0,    -1,    -1,    13
};
...
{
       0,     3,     4,     5,     7,     9,    10,    17,    18,    19,
      20,    21,    22,    23,    12,     4,    22,    22,    20,     0,
      19,     7,     9,    13,     6,     8,    20,    11,    21,    21,
      22,    22,    13
};
...
#line 1259 "calculator.cpp"
    break;

  case 10: /* Expr: Term  */
#line 124 "calculator.y"
            {
                /* Expr = Term */
                (yyval.node) = (yyvsp[0].node);
            }
#line 1268 "calculator.cpp"
    break;

  case 11: /* Term: Term T_MUL P  */
...
#line 1279 "calculator.cpp"
    break;

  case 12: /* Term: Term T_DIV P  */
...
#line 149 "calculator.y"
            {
                ...
                temp_val.lineno = (yyvsp[0].node)->attr.lineno;
                struct ast_node *temp_node  = new struct ast_node();
                temp_node->attr = temp_val;
                (yyval.node) = new_ast_node(AST_OP_ADD, temp_node, (yyvsp[0].node));
            }
#line 1314 "calculator.cpp"
    break;

  case 15: /* P: T_SUB P  */
#line 160 "calculator.y"
            {
            // 创建一个AST_OP_MUL类型的中间节点，孩子为Expr($1)和Term($3)
                struct ast_node_attr temp_val;
                temp_val.kind = DIGIT_KIND_INT;
                ...
                (yyval.node) = new_ast_node(AST_OP_SUB, temp_node, (yyvsp[0].node));
            }
#line 1330 "calculator.cpp"
    break;
...
#line 1362 "calculator.cpp"
    break;

  case 19: /* Factor: T_FLOAT  */
#line 192 "calculator.y"
            {
                // 终结符作为抽象语法树的叶子节点进行创建
...
#line 1390 "calculator.cpp"
    break;


#line 1394 "calculator.cpp"
